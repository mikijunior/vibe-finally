...
- [x] 01-02-PLAN.md
- [x] 01-03-PLAN.md
- [x] 01-01: SQLite schema and lazy initialization (DB-01, DB-04)
- [x] 01-02: WAL mode and INTEGER cents storage (DB-02, DB-03)
- [x] 01-03: Thread-safe PriceCache with MarketDataSource interface (MKT-06, MKT-07)
