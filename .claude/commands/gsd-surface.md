...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/mijunior/vibecode/finally/.claude/.gsd-surface.json`
(sibling to `/Users/mijunior/vibecode/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/mijunior/vibecode/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/mijunior/vibecode/finally/.claude/skills`).
...
`/Users/mijunior/vibecode/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/mijunior/vibecode/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/mijunior/vibecode/finally/.claude/.gsd-surface.json`
Install profile marker: `/Users/mijunior/vibecode/finally/.claude/.gsd-profile`
Skill dirs: `/Users/mijunior/vibecode/finally/.claude/skills/gsd-*/`
Engine module: `/Users/mijunior/vibecode/finally/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/mijunior/vibecode/finally/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
