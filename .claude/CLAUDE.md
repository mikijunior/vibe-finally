...
**Core Value:** A single-container, zero-setup trading platform where AI agents collaborate to build a professional-grade trading workstation that any student can launch with one Docker command.
