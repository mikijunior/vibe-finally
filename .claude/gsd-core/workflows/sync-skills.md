...
INSTALL_JS_GLOBAL="/Users/mijunior/vibecode/finally/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/mijunior/vibecode/finally/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
