...
```
Agent(
  prompt="Read /Users/mijunior/vibecode/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mijunior/vibecode/finally/.claude/gsd-core/templates/SECURITY.md`
