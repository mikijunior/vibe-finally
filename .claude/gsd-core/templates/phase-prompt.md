...
<!-- For checkpoint task examples and patterns, see @/Users/mijunior/vibecode/finally/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/mijunior/vibecode/finally/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/mijunior/vibecode/finally/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/mijunior/vibecode/finally/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
